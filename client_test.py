...
class ClientTest(unittest.TestCase):
    ...
    def test_getRatio_illegal_argument(self):
        quotes = [
            {'top_ask': {'price': "NA/N", 'size': 36}, 'timestamp': '2019-02-11 22:06:30.572453',
             'top_bid': {'price': 121.2, 'size': 109}, 'id': '0.109974697771', 'stock': 'ABC'},
            {'top_ask': {'price': 121.68, 'size': 4}, 'timestamp': '2019-02-11 22:06:30.572453',
             'top_bid': {'price': 'NAN', 'size': 81}, 'id': '0.109974697771', 'stock': 'DEF'}
        ]
        for quote in quotes:
            self.assertIsNone(getRatio(quote['top_ask']['price'], quote['top_bid']['price']))
